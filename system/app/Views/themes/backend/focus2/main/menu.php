...
error_log("Processing Menus: " . json_encode($permission));
$menus = [];
        ...
        <ul class="metismenu" id="menu">
            ...
            if (($menus && is_array($menus) && count($menus))) {
                foreach ($menus as $menu) {
                    error_log("Processing menu: " . json_encode($menu));
            ...
            ?>
            <!-- Explicitly stated VPN menu items -->
            <li><a class="has-arrow" href="Javascript:void()" aria-expanded="false"><i class="fas fa-network-wired"></i><span class="nav-text"><?= lang('App.menu_vpn') ?></span></a>
                <ul aria-expanded="false">
                    <li><a href="<?= site_url('vpn/create') ?>"><?= lang('App.menu_create_vpn') ?></a></li>
                    <li><a href="<?= site_url('vpn/list') ?>"><?= lang('App.menu_list_vpns') ?></a></li>
                </ul>
            </li>
        </ul>
    </div>
